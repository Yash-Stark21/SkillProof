...
Phase 1 converts the existing concept into an implementation-ready product baseline. SkillProof’s governing rule is:

> No evidence, no claim.

The phase establishes the product scope, requirements, architecture boundaries, risks, evidence contract, synthetic test corpus, prioritized backlog, and Sprint 1 entry criteria.
...
- All new project documentation uses UTF-8 encoding.
